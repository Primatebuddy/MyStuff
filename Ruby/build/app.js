...
(function(Opal) {
  ...
  Opal.add_stubs(['$attr_reader', '$remove', '$add', '$const_defined?', '$opacity', '$color', '$opacity=', '$raise', '$map', '$new', '$[]', '$length', '$each', '$!', '$is_valid?', '$class', '$===', '$==', '$rand', '$is_hex?', '$hex_to_f', '$key?', '$all?', '$is_a?', '$include?', '$private', '$push', '$/', '$to_proc', '$each_slice', '$chars', '$to_i', '$to_f', '$attr_accessor', '$next', '$add_object', '$index', '$delete_at', '$clear', '$has_key?', '$new_event_key', '$[]=', '$delete', '$type', '$id', '$downcase', '$call', '$to_sym', '$ext_window_show', '$ext_window_close', '$>', '$z', '$insert', '$get', '$set', '$on', '$off', '$update', '$show', '$close', '$include', '$color=', '$from', '$update_color', '$+', '$triangle_area', '$<=', '$abs', '$-', '$*', '$points_distance', '$<', '$x1', '$y1', '$x2', '$y2', '$sqrt', '$**', '$update_coords', '$width=', '$height=', '$ext_image_init', '$ext_sprite_init', '$clip', '$merge!', '$!=', '$animate_frames', '$clip_with_current_frame', '$to_s', '$ext_text_init', '$ext_text_set', '$=~', '$exists?', '$ext_sound_init', '$ext_sound_play', '$ext_music_init', '$ext_music_play', '$ext_music_pause', '$ext_music_resume', '$ext_music_stop', '$ext_music_fadeout']);
  (function($base) {
    ...
    (function($base) {
      ...
      Opal.defn(self, '$z=', TMP_1 = function(z) {
        var self = this;
      ...
      Opal.defn(self, '$add', TMP_2 = function $$add() {
        var $a, self = this;
      ...
      Opal.defn(self, '$remove', TMP_3 = function $$remove() {
        var $a, self = this;
      ...
      Opal.defn(self, '$opacity', TMP_4 = function $$opacity() {
        var self = this;

        return self.$color().$opacity();
      }, TMP_4.$$arity = 0);

      Opal.defn(self, '$opacity=', TMP_5 = function(val) {
        var $a, $b, self = this;

        return (($a = [val]), $b = self.$color(), $b['$opacity='].apply($b, $a), $a[$a.length-1]);
      }, TMP_5.$$arity = 1);

      Opal.defn(self, '$contains?', TMP_6 = function(x, y) {
        var self = this;
  ...
  (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_14, TMP_15, TMP_17, TMP_19, TMP_20, TMP_21, TMP_23, TMP_25;
      ...
      (function($base, $super) {
        ...
        var def = self.$$proto, $scope = self.$$scope, TMP_8, TMP_9, TMP_10, TMP_11, TMP_13;

        def.colors = nil;
        Opal.defn(self, '$initialize', TMP_8 = function $$initialize(colors) {
          var $a, $b, TMP_7, self = this;

          return self.colors = ($a = ($b = colors).$map, $a.$$p = (TMP_7 = function(c){var self = TMP_7.$$s || this;
if (c == null) c = nil;
          return $scope.get('Color').$new(c)}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7), $a).call($b);
        }, TMP_8.$$arity = 1);

        Opal.defn(self, '$[]', TMP_9 = function(i) {
          var self = this;

          return self.colors['$[]'](i);
        }, TMP_9.$$arity = 1);

        Opal.defn(self, '$length', TMP_10 = function $$length() {
          var self = this;

          return self.colors.$length();
        }, TMP_10.$$arity = 0);

        Opal.defn(self, '$opacity', TMP_11 = function $$opacity() {
          var self = this;

          return self.colors['$[]'](0).$opacity();
        }, TMP_11.$$arity = 0);

        return (Opal.defn(self, '$opacity=', TMP_13 = function(opacity) {
          var $a, $b, TMP_12, self = this;

          return ($a = ($b = self.colors).$each, $a.$$p = (TMP_12 = function(color){var self = TMP_12.$$s || this, $c, $d;
if (color == null) color = nil;
          return (($c = [opacity]), $d = color, $d['$opacity='].apply($d, $c), $c[$c.length-1])}, TMP_12.$$s = self, TMP_12.$$arity = 1, TMP_12), $a).call($b);
        }, TMP_13.$$arity = 1), nil) && 'opacity=';
      })($scope.base, null);
      ...
      Opal.defn(self, '$initialize', TMP_14 = function $$initialize(c) {
      ...
      Opal.defs(self, '$is_hex?', TMP_15 = function(s) {
        var $a, $b, self = this;

        return ($a = (($b = s.$class()['$==']($scope.get('String'))) ? s['$[]'](0)['$==']("#") : s.$class()['$==']($scope.get('String'))), $a !== false && $a !== nil && $a != null ?s.$length()['$=='](7) : $a);
      }, TMP_15.$$arity = 1);

      Opal.defs(self, '$is_valid?', TMP_17 = function(c) {
        var $a, $b, $c, $d, TMP_16, self = this;

        return ((($a = ((($b = (($c = Opal.cvars['@@colors']) == null ? nil : $c)['$key?'](c)) !== false && $b !== nil && $b != null) ? $b : self['$is_hex?'](c))) !== false && $a !== nil && $a != null) ? $a : ($b = (($c = c.$class()['$==']($scope.get('Array'))) ? c.$length()['$=='](4) : c.$class()['$==']($scope.get('Array'))), $b !== false && $b !== nil && $b != null ?($c = ($d = c)['$all?'], $c.$$p = (TMP_16 = function(el){var self = TMP_16.$$s || this, $e;
if (el == null) el = nil;
        return ($e = el['$is_a?']($scope.get('Numeric')), $e !== false && $e !== nil && $e != null ?($range(0.0, 1.0, false))['$include?'](el) : $e)}, TMP_16.$$s = self, TMP_16.$$arity = 1, TMP_16), $c).call($d) : $b));
      }, TMP_17.$$arity = 1);

      Opal.defs(self, '$from', TMP_19 = function $$from(input) {
        var $a, $b, $c, $d, TMP_18, self = this;

        if ((($a = ($b = input['$is_a?']($scope.get('Array')), $b !== false && $b !== nil && $b != null ?($c = ($d = input)['$all?'], $c.$$p = (TMP_18 = function(el){var self = TMP_18.$$s || this;
if (el == null) el = nil;
        return $scope.get('Color')['$is_valid?'](el)}, TMP_18.$$s = self, TMP_18.$$arity = 1, TMP_18), $c).call($d) : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return (($scope.get('Color')).$$scope.get('Set')).$new(input)
          } else {
          return $scope.get('Color').$new(input)
        };
      }, TMP_19.$$arity = 1);

      Opal.defn(self, '$opacity', TMP_20 = function $$opacity() {
        var self = this;

        return self.a;
      }, TMP_20.$$arity = 0);

      Opal.defn(self, '$opacity=', TMP_21 = function(opacity) {
        var self = this;
      ...
      Opal.defn(self, '$to_f', TMP_23 = function $$to_f(a) {
        var $a, $b, TMP_22, self = this, b = nil;

        b = [];
        ($a = ($b = a).$each, $a.$$p = (TMP_22 = function(n){var self = TMP_22.$$s || this;
if (n == null) n = nil;
        return b.$push($rb_divide(n, 255.0))}, TMP_22.$$s = self, TMP_22.$$arity = 1, TMP_22), $a).call($b);
        return b;
      }, TMP_23.$$arity = 1);

      return (Opal.defn(self, '$hex_to_f', TMP_25 = function $$hex_to_f(h) {
        var $a, $b, $c, TMP_24, self = this, a = nil;

        h = ($a = ($b = (h['$[]']($range(1, -1, false))).$chars().$each_slice(2)).$map, $a.$$p = "join".$to_proc(), $a).call($b);
        a = [];
        ($a = ($c = h).$each, $a.$$p = (TMP_24 = function(el){var self = TMP_24.$$s || this;
if (el == null) el = nil;
        return a.$push(el.$to_i(16))}, TMP_24.$$s = self, TMP_24.$$arity = 1, TMP_24), $a).call($c);
        a.$push(255);
        return self.$to_f(a);
      }, TMP_25.$$arity = 1), nil) && 'hex_to_f';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_27, TMP_28, TMP_29, TMP_30, TMP_32, TMP_33, TMP_34, TMP_35, TMP_36, TMP_37, TMP_42, TMP_48, TMP_53, TMP_54, TMP_55, TMP_56, TMP_58;

      def.fps_cap = def.event_key = def.title = def.background = def.width = def.height = def.viewport_width = def.viewport_height = def.resizable = def.borderless = def.fullscreen = def.highdpi = def.frames = def.fps = def.mouse_x = def.mouse_y = def.diagnostics = def.objects = def.events = def.update_proc = nil;
      self.$attr_reader("objects");

      self.$attr_accessor("mouse_x", "mouse_y", "frames", "fps");

      Opal.cdecl($scope, 'MouseEvent', $scope.get('Struct').$new("type", "button", "direction", "x", "y", "delta_x", "delta_y"));

      Opal.cdecl($scope, 'KeyEvent', $scope.get('Struct').$new("type", "key"));

      Opal.cdecl($scope, 'ControllerEvent', $scope.get('Struct').$new("which", "type", "axis", "value", "button"));

      Opal.cdecl($scope, 'EventDescriptor', $scope.get('Struct').$new("type", "id"));

      Opal.defn(self, '$initialize', TMP_27 = function $$initialize(args) {
        ...
        self.update_proc = ($a = ($b = $scope.get('Proc')).$new, $a.$$p = (TMP_26 = function(){var self = TMP_26.$$s || this;

        return nil}, TMP_26.$$s = self, TMP_26.$$arity = 0, TMP_26), $a).call($b);
        return self.diagnostics = false;
      }, TMP_27.$$arity = -1);

      Opal.defn(self, '$new_event_key', TMP_28 = function $$new_event_key() {
        var self = this;

        return self.event_key = self.event_key.$next();
      }, TMP_28.$$arity = 0);

      Opal.defn(self, '$get', TMP_29 = function $$get(sym) {
        var self = this, $case = nil;
      ...
      Opal.defn(self, '$set', TMP_30 = function $$set(opts) {
        var $a, self = this;
      ...
      Opal.defn(self, '$add', TMP_32 = function $$add(o) {
        var $a, $b, TMP_31, self = this, $case = nil;

        return (function() {$case = o;if (nil['$===']($case)) {return self.$raise($scope.get('Error'), "Cannot add '" + (o.$class()) + "' to window!")}else if ($scope.get('Array')['$===']($case)) {return ($a = ($b = o).$each, $a.$$p = (TMP_31 = function(x){var self = TMP_31.$$s || this;
if (x == null) x = nil;
        return self.$add_object(x)}, TMP_31.$$s = self, TMP_31.$$arity = 1, TMP_31), $a).call($b)}else {return self.$add_object(o)}})();
      }, TMP_32.$$arity = 1);

      Opal.defn(self, '$remove', TMP_33 = function $$remove(o) {
      ...
      Opal.defn(self, '$clear', TMP_34 = function $$clear() {
        var self = this;
      ...
      Opal.defn(self, '$on', TMP_36 = function $$on(event) {
        var $a, self = this, $iter = TMP_36.$$p, proc = $iter || nil, event_id = nil;

        TMP_36.$$p = null;
        if ((($a = self.events['$has_key?'](event)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          self.$raise($scope.get('Error'), "`" + (event) + "` is not a valid event type")
        };
        event_id = self.$new_event_key();
        self.events['$[]'](event)['$[]='](event_id, proc);
        return $scope.get('EventDescriptor').$new(event, event_id);
      }, TMP_36.$$arity = 1);

      Opal.defn(self, '$off', TMP_37 = function $$off(event_descriptor) {
        var self = this;

        return self.events['$[]'](event_descriptor.$type()).$delete(event_descriptor.$id());
      }, TMP_37.$$arity = 1);

      Opal.defn(self, '$key_callback', TMP_42 = function $$key_callback(type, key) {
        var $a, $b, TMP_38, $c, TMP_39, $d, TMP_40, $e, TMP_41, self = this, $case = nil;

        key = key.$downcase();
        ($a = ($b = self.events['$[]']("key")).$each, $a.$$p = (TMP_38 = function(id, e){var self = TMP_38.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('KeyEvent').$new(type, key))}, TMP_38.$$s = self, TMP_38.$$arity = 2, TMP_38), $a).call($b);
        return (function() {$case = type;if ("down"['$===']($case)) {return ($a = ($c = self.events['$[]']("key_down")).$each, $a.$$p = (TMP_39 = function(id, e){var self = TMP_39.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('KeyEvent').$new(type, key))}, TMP_39.$$s = self, TMP_39.$$arity = 2, TMP_39), $a).call($c)}else if ("held"['$===']($case)) {return ($a = ($d = self.events['$[]']("key_held")).$each, $a.$$p = (TMP_40 = function(id, e){var self = TMP_40.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('KeyEvent').$new(type, key))}, TMP_40.$$s = self, TMP_40.$$arity = 2, TMP_40), $a).call($d)}else if ("up"['$===']($case)) {return ($a = ($e = self.events['$[]']("key_up")).$each, $a.$$p = (TMP_41 = function(id, e){var self = TMP_41.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('KeyEvent').$new(type, key))}, TMP_41.$$s = self, TMP_41.$$arity = 2, TMP_41), $a).call($e)}else { return nil }})();
      }, TMP_42.$$arity = 2);

      Opal.defn(self, '$mouse_callback', TMP_48 = function $$mouse_callback(type, button, direction, x, y, delta_x, delta_y) {
        var $a, $b, TMP_43, $c, TMP_44, $d, TMP_45, $e, TMP_46, $f, TMP_47, self = this, $case = nil;
        ...
        ($a = ($b = self.events['$[]']("mouse")).$each, $a.$$p = (TMP_43 = function(id, e){var self = TMP_43.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('MouseEvent').$new(type, button, direction, x, y, delta_x, delta_y))}, TMP_43.$$s = self, TMP_43.$$arity = 2, TMP_43), $a).call($b);
        return (function() {$case = type;if ("down"['$===']($case)) {return ($a = ($c = self.events['$[]']("mouse_down")).$each, $a.$$p = (TMP_44 = function(id, e){var self = TMP_44.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('MouseEvent').$new(type, button, nil, x, y, nil, nil))}, TMP_44.$$s = self, TMP_44.$$arity = 2, TMP_44), $a).call($c)}else if ("up"['$===']($case)) {return ($a = ($d = self.events['$[]']("mouse_up")).$each, $a.$$p = (TMP_45 = function(id, e){var self = TMP_45.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('MouseEvent').$new(type, button, nil, x, y, nil, nil))}, TMP_45.$$s = self, TMP_45.$$arity = 2, TMP_45), $a).call($d)}else if ("scroll"['$===']($case)) {return ($a = ($e = self.events['$[]']("mouse_scroll")).$each, $a.$$p = (TMP_46 = function(id, e){var self = TMP_46.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('MouseEvent').$new(type, nil, direction, nil, nil, delta_x, delta_y))}, TMP_46.$$s = self, TMP_46.$$arity = 2, TMP_46), $a).call($e)}else if ("move"['$===']($case)) {return ($a = ($f = self.events['$[]']("mouse_move")).$each, $a.$$p = (TMP_47 = function(id, e){var self = TMP_47.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('MouseEvent').$new(type, nil, nil, x, y, delta_x, delta_y))}, TMP_47.$$s = self, TMP_47.$$arity = 2, TMP_47), $a).call($f)}else { return nil }})();
      }, TMP_48.$$arity = 7);

      Opal.defn(self, '$controller_callback', TMP_53 = function $$controller_callback(which, type, axis, value, button) {
        var $a, $b, TMP_49, $c, TMP_50, $d, TMP_51, $e, TMP_52, self = this, $case = nil;

        ($a = ($b = self.events['$[]']("controller")).$each, $a.$$p = (TMP_49 = function(id, e){var self = TMP_49.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('ControllerEvent').$new(which, type, axis, value, button))}, TMP_49.$$s = self, TMP_49.$$arity = 2, TMP_49), $a).call($b);
        return (function() {$case = type;if ("axis"['$===']($case)) {return ($a = ($c = self.events['$[]']("controller_axis")).$each, $a.$$p = (TMP_50 = function(id, e){var self = TMP_50.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('ControllerEvent').$new(which, type, axis, value, nil))}, TMP_50.$$s = self, TMP_50.$$arity = 2, TMP_50), $a).call($c)}else if ("button_down"['$===']($case)) {return ($a = ($d = self.events['$[]']("controller_button_down")).$each, $a.$$p = (TMP_51 = function(id, e){var self = TMP_51.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('ControllerEvent').$new(which, type, nil, nil, button))}, TMP_51.$$s = self, TMP_51.$$arity = 2, TMP_51), $a).call($d)}else if ("button_up"['$===']($case)) {return ($a = ($e = self.events['$[]']("controller_button_up")).$each, $a.$$p = (TMP_52 = function(id, e){var self = TMP_52.$$s || this;
if (id == null) id = nil;if (e == null) e = nil;
        return e.$call($scope.get('ControllerEvent').$new(which, type, nil, nil, button))}, TMP_52.$$s = self, TMP_52.$$arity = 2, TMP_52), $a).call($e)}else { return nil }})();
      }, TMP_53.$$arity = 5);

      Opal.defn(self, '$update_callback', TMP_54 = function $$update_callback() {
        var self = this;

        return self.update_proc.$call();
      }, TMP_54.$$arity = 0);

      Opal.defn(self, '$show', TMP_55 = function $$show() {
        var self = this;

        return self.$ext_window_show();
      }, TMP_55.$$arity = 0);

      Opal.defn(self, '$close', TMP_56 = function $$close() {
        var self = this;

        return self.$ext_window_close();
      }, TMP_56.$$arity = 0);

      self.$private();

      return (Opal.defn(self, '$add_object', TMP_58 = function $$add_object(o) {
        var $a, $b, TMP_57, self = this, index = nil;

        if ((($a = self.objects['$include?'](o)['$!']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          index = ($a = ($b = self.objects).$index, $a.$$p = (TMP_57 = function(object){var self = TMP_57.$$s || this;
if (object == null) object = nil;
          return $rb_gt(object.$z(), o.$z())}, TMP_57.$$s = self, TMP_57.$$arity = 1, TMP_57), $a).call($b);
          if (index !== false && index !== nil && index != null) {
  ...
  (function($base) {
    ...
    (function(self) {
      var $scope = self.$$scope, def = self.$$proto, TMP_59, TMP_60, TMP_61, TMP_62, TMP_63, TMP_64, TMP_65, TMP_66, TMP_67, TMP_68;

      (Opal.cvars['@@window'] = (($scope.get('Ruby2D')).$$scope.get('Window')).$new());
      Opal.defn(self, '$get', TMP_59 = function $$get(sym) {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$get(sym);
      }, TMP_59.$$arity = 1);
      Opal.defn(self, '$set', TMP_60 = function $$set(opts) {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$set(opts);
      }, TMP_60.$$arity = 1);
      Opal.defn(self, '$on', TMP_61 = function $$on(event) {
        var $a, $b, $c, self = this, $iter = TMP_61.$$p, proc = $iter || nil;

        TMP_61.$$p = null;
        return ($a = ($b = (($c = Opal.cvars['@@window']) == null ? nil : $c)).$on, $a.$$p = proc.$to_proc(), $a).call($b, event);
      }, TMP_61.$$arity = 1);
      Opal.defn(self, '$off', TMP_62 = function $$off(event_descriptor) {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$off(event_descriptor);
      }, TMP_62.$$arity = 1);
      Opal.defn(self, '$add', TMP_63 = function $$add(o) {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$add(o);
      }, TMP_63.$$arity = 1);
      Opal.defn(self, '$remove', TMP_64 = function $$remove(o) {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$remove(o);
      }, TMP_64.$$arity = 1);
      Opal.defn(self, '$clear', TMP_65 = function $$clear() {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$clear();
      }, TMP_65.$$arity = 0);
      Opal.defn(self, '$update', TMP_66 = function $$update() {
        var $a, $b, $c, self = this, $iter = TMP_66.$$p, proc = $iter || nil;

        TMP_66.$$p = null;
        return ($a = ($b = (($c = Opal.cvars['@@window']) == null ? nil : $c)).$update, $a.$$p = proc.$to_proc(), $a).call($b);
      }, TMP_66.$$arity = 0);
      Opal.defn(self, '$show', TMP_67 = function $$show() {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$show();
      }, TMP_67.$$arity = 0);
      return (Opal.defn(self, '$close', TMP_68 = function $$close() {
        var $a, self = this;

        return (($a = Opal.cvars['@@window']) == null ? nil : $a).$close();
      }, TMP_68.$$arity = 0), nil) && 'close';
    })(Opal.get_singleton_class(self))
  })($scope.get('Ruby2D'));
  (function($base) {
    var $DSL, self = $DSL = $module($base, 'DSL');

    var def = self.$$proto, $scope = self.$$scope, TMP_69, TMP_70, TMP_71, TMP_72, TMP_73, TMP_74, TMP_75, TMP_76;

    Opal.defn(self, '$get', TMP_69 = function $$get(sym) {
      var self = this;

      return $scope.get('Application').$get(sym);
    }, TMP_69.$$arity = 1);

    Opal.defn(self, '$set', TMP_70 = function $$set(opts) {
      var self = this;

      return $scope.get('Application').$set(opts);
    }, TMP_70.$$arity = 1);

    Opal.defn(self, '$on', TMP_71 = function $$on(event) {
      var $a, $b, self = this, $iter = TMP_71.$$p, proc = $iter || nil;

      TMP_71.$$p = null;
      return ($a = ($b = $scope.get('Application')).$on, $a.$$p = proc.$to_proc(), $a).call($b, event);
    }, TMP_71.$$arity = 1);

    Opal.defn(self, '$off', TMP_72 = function $$off(event_descriptor) {
      var self = this;

      return $scope.get('Application').$off(event_descriptor);
    }, TMP_72.$$arity = 1);

    Opal.defn(self, '$update', TMP_73 = function $$update() {
      var $a, $b, self = this, $iter = TMP_73.$$p, proc = $iter || nil;

      TMP_73.$$p = null;
      return ($a = ($b = $scope.get('Application')).$update, $a.$$p = proc.$to_proc(), $a).call($b);
    }, TMP_73.$$arity = 0);

    Opal.defn(self, '$clear', TMP_74 = function $$clear() {
      var self = this;

      return $scope.get('Application').$clear();
    }, TMP_74.$$arity = 0);

    Opal.defn(self, '$show', TMP_75 = function $$show() {
      var self = this;

      return $scope.get('Application').$show();
    }, TMP_75.$$arity = 0);

    Opal.defn(self, '$close', TMP_76 = function $$close() {
      var self = this;
  ...
  (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_77, TMP_78, TMP_79, TMP_80, TMP_81;

      def.color = def.x1 = def.y1 = def.x2 = def.y2 = def.x3 = def.y3 = def.x4 = def.y4 = nil;
      self.$include($scope.get('Renderable'));

      self.$attr_accessor("x1", "y1", "c1", "x2", "y2", "c2", "x3", "y3", "c3", "x4", "y4", "c4");

      self.$attr_reader("color");

      Opal.defn(self, '$initialize', TMP_77 = function $$initialize(opts) {
        var $a, $b, $c, self = this;
        ...
        self.type_id = 2;
        self.x1 = ((($a = opts['$[]']("x1")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.y1 = ((($a = opts['$[]']("y1")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.x2 = ((($a = opts['$[]']("x2")) !== false && $a !== nil && $a != null) ? $a : 100);
        self.y2 = ((($a = opts['$[]']("y2")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.x3 = ((($a = opts['$[]']("x3")) !== false && $a !== nil && $a != null) ? $a : 100);
        self.y3 = ((($a = opts['$[]']("y3")) !== false && $a !== nil && $a != null) ? $a : 100);
        self.x4 = ((($a = opts['$[]']("x4")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.y4 = ((($a = opts['$[]']("y4")) !== false && $a !== nil && $a != null) ? $a : 100);
        self.z = ((($a = opts['$[]']("z")) !== false && $a !== nil && $a != null) ? $a : 0);
        (($a = [((($c = opts['$[]']("color")) !== false && $c !== nil && $c != null) ? $c : "white")]), $b = self, $b['$color='].apply($b, $a), $a[$a.length-1]);
        return self.$add();
      }, TMP_77.$$arity = -1);

      Opal.defn(self, '$color=', TMP_78 = function(c) {
        var self = this;

        self.color = $scope.get('Color').$from(c);
        return self.$update_color(self.color);
      }, TMP_78.$$arity = 1);

      Opal.defn(self, '$contains?', TMP_79 = function(x, y) {
      ...
      Opal.defn(self, '$triangle_area', TMP_80 = function $$triangle_area(x1, y1, x2, y2, x3, y3) {
        var self = this;
      ...
      return (Opal.defn(self, '$update_color', TMP_81 = function $$update_color(c) {
        var $a, self = this;

        if ((($a = c['$is_a?']((($scope.get('Color')).$$scope.get('Set')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          if (c.$length()['$=='](4)) {
            self.c1 = c['$[]'](0);
            self.c2 = c['$[]'](1);
            self.c3 = c['$[]'](2);
            ...
            return self.$raise($scope.get('ArgumentError'), "Quads require 4 colors, one for each vertex. " + (c.$length()) + " were given.")
          }
          } else {
          self.c1 = c;
          self.c2 = c;
      ...
      }, TMP_81.$$arity = 1), nil) && 'update_color';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_82, TMP_83, TMP_84, TMP_85, TMP_86, TMP_87;
      ...
      Opal.defn(self, '$initialize', TMP_82 = function $$initialize(opts) {
        var $a, $b, $c, self = this;
        ...
        self.y1 = ((($a = opts['$[]']("y1")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.x2 = ((($a = opts['$[]']("x2")) !== false && $a !== nil && $a != null) ? $a : 100);
        self.y2 = ((($a = opts['$[]']("y2")) !== false && $a !== nil && $a != null) ? $a : 100);
        self.width = ((($a = opts['$[]']("width")) !== false && $a !== nil && $a != null) ? $a : 2);
        self.z = ((($a = opts['$[]']("z")) !== false && $a !== nil && $a != null) ? $a : 0);
        (($a = [((($c = opts['$[]']("color")) !== false && $c !== nil && $c != null) ? $c : "white")]), $b = self, $b['$color='].apply($b, $a), $a[$a.length-1]);
        return self.$add();
      }, TMP_82.$$arity = -1);

      Opal.defn(self, '$color=', TMP_83 = function(c) {
        var self = this;
      ...
      Opal.defn(self, '$length', TMP_84 = function $$length() {
        var self = this;

        return self.$points_distance(self.x1, self.y1, self.x2, self.y2);
      }, TMP_84.$$arity = 0);

      Opal.defn(self, '$contains?', TMP_85 = function(x, y) {
        var $a, $b, self = this;

        return ($a = ($b = $rb_lt(self.$points_distance(self.$x1(), self.$y1(), x, y), self.$length()), $b !== false && $b !== nil && $b != null ?$rb_lt(self.$points_distance(self.$x2(), self.$y2(), x, y), self.$length()) : $b), $a !== false && $a !== nil && $a != null ?$rb_lt(($rb_divide(($rb_minus($rb_plus($rb_minus($rb_times(($rb_minus(self.y2, self.y1)), x), $rb_times(($rb_minus(self.x2, self.x1)), y)), $rb_times(self.x2, self.y1)), $rb_times(self.y2, self.x1))).$abs(), self.$length())), $rb_times(0.5, self.width)) : $a);
      }, TMP_85.$$arity = 2);

      self.$private();

      Opal.defn(self, '$points_distance', TMP_86 = function $$points_distance(x1, y1, x2, y2) {
        var self = this;

        return $scope.get('Math').$sqrt($rb_plus(($rb_minus(x1, x2))['$**'](2), ($rb_minus(y1, y2))['$**'](2)));
      }, TMP_86.$$arity = 4);

      return (Opal.defn(self, '$update_color', TMP_87 = function $$update_color(c) {
        var $a, self = this;
        ...
        if ((($a = c['$is_a?']((($scope.get('Color')).$$scope.get('Set')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          if (c.$length()['$=='](4)) {
            ...
            return self.$raise($scope.get('ArgumentError'), "Lines require 4 colors, one for each vertex. " + (c.$length()) + " were given.")
          }
          } else {
          self.c1 = c;
          self.c2 = c;
      ...
      }, TMP_87.$$arity = 1), nil) && 'update_color';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_88, TMP_89, TMP_90, TMP_91, TMP_92, TMP_93, TMP_94;

      def.x = def.y = def.width = def.height = nil;
      self.$attr_reader("x", "y", "width", "height");

      Opal.defn(self, '$initialize', TMP_88 = function $$initialize(opts) {
        var $a, $b, $c, self = this;
        ...
        self.type_id = 2;
        self.x = ((($a = opts['$[]']("x")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.y = ((($a = opts['$[]']("y")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.z = ((($a = opts['$[]']("z")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.width = ((($a = opts['$[]']("width")) !== false && $a !== nil && $a != null) ? $a : 200);
        self.height = ((($a = opts['$[]']("height")) !== false && $a !== nil && $a != null) ? $a : 100);
        self.$update_coords(self.x, self.y, self.width, self.height);
        (($a = [((($c = opts['$[]']("color")) !== false && $c !== nil && $c != null) ? $c : "white")]), $b = self, $b['$color='].apply($b, $a), $a[$a.length-1]);
        return self.$add();
      }, TMP_88.$$arity = -1);

      Opal.defn(self, '$x=', TMP_89 = function(x) {
        var self = this;
      ...
      Opal.defn(self, '$y=', TMP_90 = function(y) {
        var self = this;
      ...
      Opal.defn(self, '$width=', TMP_91 = function(w) {
        var self = this;
      ...
      Opal.defn(self, '$height=', TMP_92 = function(h) {
        var self = this;
      ...
      Opal.defn(self, '$contains?', TMP_93 = function(x, y) {
        var $a, $b, $c, self = this;

        return ($a = ($b = ($c = $rb_lt(self.x, x), $c !== false && $c !== nil && $c != null ?$rb_gt($rb_plus(self.x, self.width), x) : $c), $b !== false && $b !== nil && $b != null ?$rb_lt(self.y, y) : $b), $a !== false && $a !== nil && $a != null ?$rb_gt($rb_plus(self.y, self.height), y) : $a);
      }, TMP_93.$$arity = 2);

      self.$private();

      return (Opal.defn(self, '$update_coords', TMP_94 = function $$update_coords(x, y, w, h) {
        var self = this;
      ...
      }, TMP_94.$$arity = 4), nil) && 'update_coords';
  ...
  (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_95, TMP_96;

      def.x = def.y = def.size = nil;
      self.$attr_reader("size");

      Opal.defn(self, '$initialize', TMP_95 = function $$initialize(opts) {
        var $a, $b, $c, self = this;
        ...
        self.y = ((($a = opts['$[]']("y")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.z = ((($a = opts['$[]']("z")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.width = self.height = self.size = ((($a = opts['$[]']("size")) !== false && $a !== nil && $a != null) ? $a : 100);
        (($a = [((($c = opts['$[]']("color")) !== false && $c !== nil && $c != null) ? $c : "white")]), $b = self, $b['$color='].apply($b, $a), $a[$a.length-1]);
        self.$update_coords(self.x, self.y, self.size, self.size);
        return self.$add();
      }, TMP_95.$$arity = -1);

      Opal.defn(self, '$size=', TMP_96 = function(s) {
        var $a, $b, $c, $d, self = this;
  ...
  (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_97, TMP_98, TMP_99, TMP_100, TMP_101;
      ...
      Opal.defn(self, '$initialize', TMP_97 = function $$initialize(opts) {
        var $a, $b, $c, self = this;
        ...
        self.type_id = 1;
        self.x1 = ((($a = opts['$[]']("x1")) !== false && $a !== nil && $a != null) ? $a : 50);
        self.y1 = ((($a = opts['$[]']("y1")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.x2 = ((($a = opts['$[]']("x2")) !== false && $a !== nil && $a != null) ? $a : 100);
        self.y2 = ((($a = opts['$[]']("y2")) !== false && $a !== nil && $a != null) ? $a : 100);
        self.x3 = ((($a = opts['$[]']("x3")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.y3 = ((($a = opts['$[]']("y3")) !== false && $a !== nil && $a != null) ? $a : 100);
        self.z = ((($a = opts['$[]']("z")) !== false && $a !== nil && $a != null) ? $a : 0);
        (($a = [((($c = opts['$[]']("color")) !== false && $c !== nil && $c != null) ? $c : "white")]), $b = self, $b['$color='].apply($b, $a), $a[$a.length-1]);
        return self.$add();
      ...
      Opal.defn(self, '$color=', TMP_98 = function(c) {
        var self = this;
      ...
      Opal.defn(self, '$contains?', TMP_99 = function(x, y) {
        var self = this, self_area = nil, questioned_area = nil;
      ...
      Opal.defn(self, '$triangle_area', TMP_100 = function $$triangle_area(x1, y1, x2, y2, x3, y3) {
        var self = this;

        return $rb_divide(($rb_minus($rb_minus($rb_minus($rb_plus($rb_plus($rb_times(x1, y2), $rb_times(x2, y3)), $rb_times(x3, y1)), $rb_times(x3, y2)), $rb_times(x1, y3)), $rb_times(x2, y1))).$abs(), 2);
      }, TMP_100.$$arity = 6);

      return (Opal.defn(self, '$update_color', TMP_101 = function $$update_color(c) {
        var $a, self = this;
        ...
        if ((($a = c['$is_a?']((($scope.get('Color')).$$scope.get('Set')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          if (c.$length()['$=='](3)) {
            ...
            return self.$raise($scope.get('ArgumentError'), "Triangles require 3 colors, one for each vertex. " + (c.$length()) + " were given.")
          }
          } else {
          self.c1 = c;
          self.c2 = c;
      ...
      }, TMP_101.$$arity = 1), nil) && 'update_color';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_102, TMP_103, TMP_104;
      ...
      Opal.defn(self, '$initialize', TMP_102 = function $$initialize(opts) {
        var $a, $b, $c, self = this;
        ...
        self.y = ((($a = opts['$[]']("y")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.z = ((($a = opts['$[]']("z")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.width = ((($a = opts['$[]']("width")) !== false && $a !== nil && $a != null) ? $a : nil);
        self.height = ((($a = opts['$[]']("height")) !== false && $a !== nil && $a != null) ? $a : nil);
        self.type_id = 4;
        (($a = [((($c = opts['$[]']("color")) !== false && $c !== nil && $c != null) ? $c : "white")]), $b = self, $b['$color='].apply($b, $a), $a[$a.length-1]);
        self.$ext_image_init(self.path);
        return self.$add();
      }, TMP_102.$$arity = -1);

      Opal.defn(self, '$color=', TMP_103 = function(c) {
        var self = this;

        return self.color = $scope.get('Color').$new(c);
      }, TMP_103.$$arity = 1);

      return (Opal.defn(self, '$contains?', TMP_104 = function(x, y) {
        var $a, $b, $c, self = this;

        return ($a = ($b = ($c = $rb_lt(self.x, x), $c !== false && $c !== nil && $c != null ?$rb_gt($rb_plus(self.x, self.width), x) : $c), $b !== false && $b !== nil && $b != null ?$rb_lt(self.y, y) : $b), $a !== false && $a !== nil && $a != null ?$rb_gt($rb_plus(self.y, self.height), y) : $a);
      }, TMP_104.$$arity = 2), nil) && 'contains?';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_105, TMP_106, TMP_107, TMP_108, TMP_109, TMP_110, TMP_111, TMP_112, TMP_113;
      ...
      Opal.defn(self, '$initialize', TMP_105 = function $$initialize(x, y, path, z) {
        var $a, self = this;
      ...
      Opal.defn(self, '$start', TMP_106 = function $$start(x, y, w, h) {
        var self = this;
      ...
      Opal.defn(self, '$add', TMP_107 = function $$add(animations) {
        var self = this;

        return self.animations['$merge!'](animations);
      }, TMP_107.$$arity = 1);

      Opal.defn(self, '$animate', TMP_108 = function $$animate(animation) {
        var $a, self = this;
      ...
      Opal.defn(self, '$reset', TMP_109 = function $$reset() {
        var self = this;
      ...
      Opal.defn(self, '$remove', TMP_110 = function $$remove() {
        var $a, self = this;
      ...
      Opal.defn(self, '$clip', TMP_111 = function $$clip(x, y, w, h) {
        var $a, self = this;

        return $a = [x, y, w, h], self.clip_x = $a[0], self.clip_y = $a[1], self.clip_w = $a[2], self.clip_h = $a[3], $a;
      }, TMP_111.$$arity = 4);

      Opal.defn(self, '$animate_frames', TMP_112 = function $$animate_frames(frames) {
        var $a, self = this;
      ...
      return (Opal.defn(self, '$clip_with_current_frame', TMP_113 = function $$clip_with_current_frame(frames) {
        var self = this;
      ...
      }, TMP_113.$$arity = 1), nil) && 'clip_with_current_frame';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_114, TMP_115, TMP_116, TMP_117, TMP_118;
      ...
      Opal.defn(self, '$initialize', TMP_114 = function $$initialize(opts) {
        var $a, $b, $c, self = this;
        ...
        self.y = ((($a = opts['$[]']("y")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.z = ((($a = opts['$[]']("z")) !== false && $a !== nil && $a != null) ? $a : 0);
        self.text = (((($a = opts['$[]']("text")) !== false && $a !== nil && $a != null) ? $a : "Hello World!")).$to_s();
        self.size = ((($a = opts['$[]']("size")) !== false && $a !== nil && $a != null) ? $a : 20);
        self.font = opts['$[]']("font");
        if ($scope.get('RUBY_ENGINE')['$==']("opal")) {};
        (($a = [((($c = opts['$[]']("color")) !== false && $c !== nil && $c != null) ? $c : "white")]), $b = self, $b['$color='].apply($b, $a), $a[$a.length-1]);
        self.$ext_text_init();
      ...
      Opal.defn(self, '$text=', TMP_115 = function(msg) {
        var self = this;

        self.text = msg.$to_s();
        return self.$ext_text_set(self.text);
      }, TMP_115.$$arity = 1);

      Opal.defn(self, '$color=', TMP_116 = function(c) {
        var self = this;

        return self.color = $scope.get('Color').$new(c);
      }, TMP_116.$$arity = 1);

      Opal.defn(self, '$contains?', TMP_117 = function(x, y) {
        var $a, $b, $c, self = this;
      ...
      return (Opal.defn(self, '$resolve_path', TMP_118 = function $$resolve_path(font) {
      ...
      }, TMP_118.$$arity = 1), nil) && 'resolve_path';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_119, TMP_120;

      self.$attr_accessor("data");

      self.$attr_reader("path");

      Opal.defn(self, '$initialize', TMP_119 = function $$initialize(path) {
        var self = this;

        if ($scope.get('RUBY_ENGINE')['$==']("opal")) {};
        self.path = path;
        return self.$ext_sound_init(path);
      }, TMP_119.$$arity = 1);

      return (Opal.defn(self, '$play', TMP_120 = function $$play() {
        var self = this;

        return self.$ext_sound_play();
      }, TMP_120.$$arity = 0), nil) && 'play';
    })($scope.base, null)
  })($scope.base);
  (function($base) {
    var $Ruby2D, self = $Ruby2D = $module($base, 'Ruby2D');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_121, TMP_122, TMP_123, TMP_124, TMP_125, TMP_126;

      self.$attr_accessor("data", "loop");

      self.$attr_reader("path");

      Opal.defn(self, '$initialize', TMP_121 = function $$initialize(path) {
        var self = this;

        if ($scope.get('RUBY_ENGINE')['$==']("opal")) {};
        self.path = path;
        self.loop = false;
        return self.$ext_music_init(path);
      }, TMP_121.$$arity = 1);

      Opal.defn(self, '$play', TMP_122 = function $$play() {
        var self = this;

        return self.$ext_music_play();
      }, TMP_122.$$arity = 0);

      Opal.defn(self, '$pause', TMP_123 = function $$pause() {
        var self = this;

        return self.$ext_music_pause();
      }, TMP_123.$$arity = 0);

      Opal.defn(self, '$resume', TMP_124 = function $$resume() {
        var self = this;

        return self.$ext_music_resume();
      }, TMP_124.$$arity = 0);

      Opal.defn(self, '$stop', TMP_125 = function $$stop() {
        var self = this;

        return self.$ext_music_stop();
      }, TMP_125.$$arity = 0);

      return (Opal.defn(self, '$fadeout', TMP_126 = function $$fadeout(ms) {
        var self = this;

        return self.$ext_music_fadeout(ms);
      }, TMP_126.$$arity = 1), nil) && 'fadeout';
    })($scope.base, null)
  })($scope.base);
...
/* Generated by Opal 0.10.5 */
(function(Opal) {
  var $a, $b, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $gvars = Opal.gvars, $module = Opal.module, $klass = Opal.klass, type = nil, direction = nil, button = nil;
...
function render() {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$ext_image_init', TMP_1 = function $$ext_image_init(path) {
        var self = this;

        return self.data = S2D.CreateImage(path, function() {
      ...
      }, TMP_1.$$arity = 1), nil) && 'ext_image_init'
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$ext_sprite_init', TMP_2 = function $$ext_sprite_init(path) {
        var self = this;

        return self.data = S2D.CreateSprite(path);;
      }, TMP_2.$$arity = 1), nil) && 'ext_sprite_init'
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$ext_text_init', TMP_3 = function $$ext_text_init() {
        var self = this;

        self.data = S2D.CreateText(self.font, self.text, self.size);;
        self.width = self.data.width;;
        return self.height = self.data.height;;
      }, TMP_3.$$arity = 0);

      return (Opal.defn(self, '$ext_text_set', TMP_4 = function $$ext_text_set(msg) {
        var self = this;

        S2D.SetText(self.data, msg);;
        self.width = self.data.width;;
        return self.height = self.data.height;;
      }, TMP_4.$$arity = 1), nil) && 'ext_text_set';
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$ext_sound_init', TMP_5 = function $$ext_sound_init(path) {
        var self = this;

        return self.data = S2D.CreateSound(path);;
      }, TMP_5.$$arity = 1);

      return (Opal.defn(self, '$ext_sound_play', TMP_6 = function $$ext_sound_play() {
        var self = this;

        return S2D.PlaySound(self.data);;
      }, TMP_6.$$arity = 0), nil) && 'ext_sound_play';
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$ext_music_init', TMP_7 = function $$ext_music_init(path) {
        var self = this;

        return self.data = S2D.CreateMusic(path);;
      }, TMP_7.$$arity = 1);

      Opal.defn(self, '$ext_music_play', TMP_8 = function $$ext_music_play() {
        var self = this;

        return S2D.PlayMusic(self.data, self.loop);;
      }, TMP_8.$$arity = 0);

      Opal.defn(self, '$ext_music_pause', TMP_9 = function $$ext_music_pause() {
        var self = this;

        S2D.PauseMusic();
      }, TMP_9.$$arity = 0);

      Opal.defn(self, '$ext_music_resume', TMP_10 = function $$ext_music_resume() {
        var self = this;

        S2D.ResumeMusic();
      }, TMP_10.$$arity = 0);

      Opal.defn(self, '$ext_music_stop', TMP_11 = function $$ext_music_stop() {
        var self = this;

        S2D.StopMusic();
      }, TMP_11.$$arity = 0);

      return (Opal.defn(self, '$ext_music_fadeout', TMP_12 = function $$ext_music_fadeout(ms) {
        var self = this;

        S2D.FadeOutMusic(ms);
      }, TMP_12.$$arity = 1), nil) && 'ext_music_fadeout';
    })($scope.base, null);
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$ext_window_show', TMP_13 = function $$ext_window_show() {
        var self = this;
        if ($gvars.R2D_WINDOW == null) $gvars.R2D_WINDOW = nil;
      ...
      S2D.Show(win);;
      }, TMP_13.$$arity = 0), nil) && 'ext_window_show'
    })($scope.base, null);
  })($scope.base);
})(Opal);
...
(function(Opal) {
  ...
  $scope.get('Triangle').$new($hash2(["x1", "y1", "x2", "y2", "x3", "y3", "color"], {"x1": 320, "y1": 50, "x2": 540, "y2": 430, "x3": 100, "y3": 430, "color": ["red", "green", "blue"]}));
  return self.$show();
})(Opal);
